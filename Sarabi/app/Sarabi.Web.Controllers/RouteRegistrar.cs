...
namespace Sarabi.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "Sarabi.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "Sarabi.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "Sarabi.Web.Controllers",
