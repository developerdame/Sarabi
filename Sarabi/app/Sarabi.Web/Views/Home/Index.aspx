    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within Sarabi.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within Sarabi.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open Sarabi.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                Sarabi.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
